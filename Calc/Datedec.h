...
char *const	date_act_actISDA_day_count_name = "ACT/ACT(ISDA)";
...
const	unsigned char	date_30US_cal = 11;
const	unsigned char	date_365A_cal = 12;
const	unsigned char	date_366_cal = 13;
