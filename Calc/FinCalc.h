...
{
public:
	enum _WEEKDAY {	_WEEKDAYNOTSET=0,_MONDAY,_TUESDAY,_WEDNESDAY,_THURSDAY,
					_FRIDAY,_SATURDAY,_SUNDAY,_BADDAY};
	enum _CALENDARBASIS {BASISNOTSET,DATEACTCAL,DATE30CAL,DATE30ECAL, DATE30GERMANCAL,DATE30EPLUSCAL, DATE30USCAL,_BADBASIS};
	enum _INSTRUMENTCLASS {CLASSNOTSET,GERMANBUND,GOVOFJAPAN,EURO,UKGILT,UKCD,UKDSC,
				USCD,USDSC,USTBOND,CP,FINANZSCHATZ,USCHATZ,USCHATZBUBA,SCHULDSCHEIN,MBS,
//				FLOAT,CASHFLOW
				};
	enum _DAYCOUNT {_DAYCOUNTNOTSET,
				_30E_360,_30_360,_ACT_360,_ACT_365,_ACT_365CD,_ACT_ACT,_ACT_365L,_ACT_ISDA, _30_360GERMAN, _NL_365, _30EPLUS_360, _30_360US, _ACT_365A, _ACT_366, _ACT_360CD
	};
	enum _PERIOD {_PERIODNOTSET,_DAYS,_MONTHS};
	enum _FREQUENCY {_FREQUENCYNOTSET,_ANNUALLY,_SEMIANNUALLY,_QUARTERLY,_MONTHLY};
	enum _YIELDMETH {_YIELDMETHNOTSET,_AIBD,_MMDISC,_MM,_YTMSIMP,_YTMCOMP,_SIMPJAP
